...
<template>
    <div>
        <div v-if="show && message" :class="{ 'bg-red-500': style == 'success', 'bg-red-700': style == 'danger' }">
            <div class="mx-auto max-w-screen-xl px-3 py-2 sm:px-6 lg:px-8">
                <div class="flex flex-wrap items-center justify-between">
                    <div class="flex w-0 min-w-0 flex-1 items-center">
                        <span :class="{ 'bg-red-600': style == 'success', 'bg-red-600': style == 'danger' }"
                              class="flex rounded-lg p-2">
                            <svg v-if="style == 'success'" class="size-5 text-white" fill="none"
                            ...
                            <svg v-if="style == 'danger'" class="size-5 text-white" fill="none"
                                 stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
