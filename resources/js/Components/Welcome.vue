        ...
        <div class="grid grid-cols-1 gap-6 bg-gray-200 bg-opacity-25 p-6 md:grid-cols-2 lg:gap-8 lg:p-8">
            <div>
                <div class="flex items-center">
                    <svg class="size-6 stroke-gray-400" fill="none" stroke-width="1.5" viewBox="0 0 24 24"
                         xmlns="http://www.w3.org/2000/svg">
                        <path d="M12 6.042A8.967 8.967 0 006 3.75c-1.052 0-2.062.18-3 .512v14.25A8.987 8.987 0 016 18c2.305 0 4.408.867 6 2.292m0-14.25a8.966 8.966 0 016-2.292c1.052 0 2.062.18 3 .512v14.25A8.987 8.987 0 0018 18a8.967 8.967 0 00-6 2.292m0-14.25v14.25" stroke-linecap="round"
                ...
                <p class="mt-4 text-sm">
                    <a class="inline-flex items-center font-semibold text-red-700" href="https://laravel.com/docs">
                        Explore the documentation

                        <svg class="ms-1 size-5 fill-red-500" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
            ...
            <div>
                ...
                <p class="mt-4 text-sm">
                    <a class="inline-flex items-center font-semibold text-red-700" href="https://laracasts.com">
